...
export default function FuturisticNavbar() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-auto flex items-center gap-3 rounded-full px-5 py-2"
        style={{
      ...
      >
        ...
        <Link
          href="#contact"
          className="rounded-full border border-white/10 bg-white/5 px-5 py-2 text-xs font-bold uppercase tracking-[0.25em] text-white/90 transition hover:border-white/20 hover:bg-white/10"
        >
          Contact
        </Link>
      </div>

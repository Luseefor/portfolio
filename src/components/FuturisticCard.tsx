...
export default function FuturisticCard({
    ...
    return (
        <motion.div
            whileHover={{ y: -5 }}
            className={`
                group relative overflow-hidden bg-black/40 backdrop-blur-xl
        ...
        >
            {/* Corner Brackets */}
            <div className="absolute top-0 left-0 w-4 h-4 border-l-2 border-t-2 transition-colors duration-300"
                style={{ borderColor: themeColor }} />
            <div className="absolute top-0 right-0 w-4 h-4 border-r-2 border-t-2 transition-colors duration-300"
                style={{ borderColor: themeColor }} />
            <div className="absolute bottom-0 left-0 w-4 h-4 border-l-2 border-b-2 transition-colors duration-300"
                style={{ borderColor: themeColor }} />
            <div className="absolute bottom-0 right-0 w-4 h-4 border-r-2 border-b-2 transition-colors duration-300"
                style={{ borderColor: themeColor }} />

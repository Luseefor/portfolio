    ...
    <div className="p-8 h-full flex flex-col justify-between relative z-10 transition-colors duration-500">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex flex-col items-end">
          ...
          <div
            className="font-mono text-2xl md:text-3xl font-bold tracking-wider text-transparent bg-clip-text"
            style={{
      ...
      <div className="mt-auto">
        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-white/5 bg-white/5 backdrop-blur-sm">
          ...
          <span className="text-sm font-medium text-slate-300">
            Currently working on: <span className="text-white font-bold">Alethic</span>{' '}
            <span className="text-slate-400 text-xs">
              - an AI powered reasoning engine for modern recruiting
            </span>
          </span>
        </div>
      </div>

...
export default function ProjectDetailsModal({ isOpen, onClose, project, themeColor }: ProjectDetailsModalProps) {
                        ...
                        >
                            ...
                            <div className="h-32 w-full relative overflow-hidden">
                                ...
                                <div
                                    ...
                                    style={{ backgroundImage: `linear-gradient(to right, ${themeColor}, transparent)` }}
                                />
                                {/* Grid Pattern */}
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {project.stack.map((tech, i) => (
                                                <span key={i} className="px-3 py-1 bg-white/5 border border-white/10 rounded-md text-xs text-slate-300 font-mono">
                                                    {tech}
                                                </span>
                                            ))}
                                        </div>

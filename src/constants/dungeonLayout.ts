  ...
  rooms: [
    {
      id: 'spawn-hall',
      center: [0, 0, 0],
      size: { width: 24, depth: 22, height: 8.8 },
      theme: 'spawn',
      props: [
        { key: 'Torch', offset: [-10.4, 2.3, -4.8], rotationY: Math.PI / 2 },
        { key: 'Torch', offset: [10.4, 2.3, -4.8], rotationY: -Math.PI / 2 },
      ],
    },
    {
      id: 'anteroom',
      center: [0, 0, 30],
      size: { width: 22, depth: 18, height: 8.8 },
      theme: 'hall',
    },
    {
      id: 'crossroads',
      center: [30, 0, 30],
      size: { width: 22, depth: 22, height: 9.2 },
      theme: 'crossroads',
    },
    {
      id: 'chapel',
      center: [30, 0, 64],
      size: { width: 30, depth: 24, height: 9.8 },
      theme: 'chapel',
    },
    {
      id: 'western-cell',
      center: [-30, 0, 30],
      size: { width: 22, depth: 22, height: 8.8 },
      theme: 'crypt',
    },
    {
      id: 'reliquary',
      center: [-30, 0, 64],
      size: { width: 24, depth: 22, height: 9.2 },
      theme: 'reliquary',
    },
    {
      id: 'treasury',
      center: [0, 0, 96],
      size: { width: 34, depth: 28, height: 10.4 },
      theme: 'treasury',
      props: [{ key: 'Torch', offset: [0, 2.3, -12], rotationY: Math.PI }],
    },
    {
      id: 'east-watch',
      center: [62, 0, 48],
      size: { width: 22, depth: 20, height: 8.8 },
      theme: 'watch',
    },
  ],
  routes: [
...
export const CHEST_POIS: ChestPOI[] = [
  {
    id: 'spawn-hall-cache-west',
    title: 'Spawn Hall Cache',
    description: 'A starter cache near the western side of the spawn hall.',
    position: [-8.5, 0, -3.5],
    interactionRadius: 2.3,
    loot: { type: 'project', label: 'Inspect Cache' },
  },
  {
    id: 'spawn-hall-cache-east',
    title: 'Spawn Hall Locker',
    description: 'A second stash tucked near the eastern spawn lane.',
    position: [8, 0, 6.5],
    interactionRadius: 2.3,
    loot: { type: 'artifact', label: 'Open Locker' },
  },
  {
    id: 'anteroom-chest',
    title: 'Anteroom Chest',
    description: 'A supply chest left along the anteroom approach.',
    position: [-4.8, 0, 28],
    interactionRadius: 2.3,
    loot: { type: 'project', label: 'Open Chest' },
  },
  {
    id: 'crossroads-chest',
    title: 'Crossroads Cache',
    description: 'A crossroads cache hidden near the north corner.',
    position: [25.5, 0, 35.5],
    interactionRadius: 2.3,
    loot: { type: 'artifact', label: 'Inspect Cache' },
  },
  {
    id: 'chapel-relic-west',
    title: 'Chapel Relic I',
    description: 'A relic chest resting under chapel stonework.',
    position: [23.5, 0, 58.5],
    interactionRadius: 2.4,
    loot: { type: 'artifact', label: 'Reveal Relic' },
  },
  {
    id: 'chapel-relic-east',
    title: 'Chapel Relic II',
    description: 'A second relic chest near the far chapel aisle.',
    position: [36, 0, 67],
    interactionRadius: 2.4,
    loot: { type: 'secret', label: 'Unseal Relic' },
  },
  {
    id: 'western-cell-chest',
    title: 'Western Cell Chest',
    description: 'An old chest abandoned in the western crypt cell.',
    position: [-34, 0, 26.5],
    interactionRadius: 2.3,
    loot: { type: 'project', label: 'Open Chest' },
  },
  {
    ...
    description: 'A reliquary chest bound with old metal trims.',
    position: [-24.5, 0, 68],
    interactionRadius: 2.3,
    loot: { type: 'artifact', label: 'Inspect Reliquary' },
  },
  {
    id: 'treasury-vault-west',
    title: 'Treasury Vault I',
    description: 'A treasury coffer on the western lane.',
    position: [-8.5, 0, 90.5],
  ...
  {
    id: 'east-watch-chest',
    title: 'East Watch Chest',
    description: 'A guard chest stored inside the eastern watch room.',
    position: [66, 0, 44],
    interactionRadius: 2.3,
    loot: { type: 'project', label: 'Inspect Chest' },
  },
];
...
export const TORCH_PLACEMENTS: Array<{
  ...
  { position: [0, 2.3, 14], rotation: [0, Math.PI, 0] },
  { position: [22, 2.3, 30], rotation: [0, Math.PI / 2, 0] },
  { position: [-22, 2.3, 36], rotation: [0, -Math.PI / 2, 0] },
  { position: [8, 2.3, 74], rotation: [0, Math.PI, 0] },
];

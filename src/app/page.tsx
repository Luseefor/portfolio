        ...
        >
          <div className="flex items-center gap-2 md:gap-3">
            <Activity
              ...
              style={{ color: securityStatus === 'SECURE' ? activeThemeColor : '#ef4444' }}
            />
            <span
              className={`w-16 inline-flex justify-center ${isDark ? 'text-white/60' : 'text-slate-900/60'}`}
            >
              <HyperText text={securityStatus} />
            </span>
          </div>
          <div
            className={`hidden h-8 w-[1px] md:block ${isDark ? 'bg-white/10' : 'bg-black/10'}`}
          />
          <ThemeDropdown
        ...
        >
          <div className="flex gap-8 md:gap-12">
            <div className="flex flex-col gap-0.5 cursor-pointer min-w-[80px]">
              <span className="opacity-40" style={{ color: activeThemeColor }}>
                Node
              </span>
              <span
                className={`transition-colors duration-1000 ${isDark ? 'text-white' : 'text-slate-950'}`}
              >
            ...
            <div className="hidden flex-col gap-0.5 sm:flex cursor-pointer min-w-[120px]">
              ...
              <span
                className={`tabular-nums transition-colors duration-1000 ${isDark ? 'text-white' : 'text-slate-950'}`}
              >
                {time}
              </span>
            </div>
